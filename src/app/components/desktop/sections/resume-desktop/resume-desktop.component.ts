...
@Component({
  selector: 'app-resume-desktop',
  templateUrl: './resume-desktop.component.html',
  styleUrls: ['./resume-desktop.component.scss']
})
export class ResumeDesktopComponent implements OnInit {
